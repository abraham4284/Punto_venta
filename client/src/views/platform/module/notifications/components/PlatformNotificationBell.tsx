...
import type { PlatformNotificationResponse } from "../types";

const severityClass: Record<PlatformNotificationResponse["severity"], string> = {
...
export const PlatformNotificationBell = () => {
  ...
  const {
    ...
    markAllAsRead,
    archive,
  } = usePlatformNotifications(10, false);
  ...
  const handleOpenNotification = async (
    notification: PlatformNotificationResponse,
  ) => {
