...
CALL sp_add_foreign_key_if_not_exists('fk_sale_details_deposit', 'ALTER TABLE `sale_details` ADD CONSTRAINT `fk_sale_details_deposit` FOREIGN KEY (`idBusiness`) REFERENCES `deposits` (`idBusiness`)');
